...
def test_Fast_Decay_FID_Signal():
    ...
    t, signal1 = FID_Signal(spin, h_unperturbed, dm_0, time_window=250, T2=100)
    t, signal2 = FID_Signal(spin, h_unperturbed, dm_0, time_window=250, T2=100, phi=math.pi)
    
    f, fourier1 = Fourier_Transform_Signal(signal1, t, 0, 20)
    f, fourier2 = Fourier_Transform_Signal(signal2, t, 0, 20)
