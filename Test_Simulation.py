...
# computed by Calculate_Phase_Shift directly to the FID signal and by rotating the detection coil by the
# same angle
def test_Two_Methods_Phase_Adjustment():
    ...
    phi = Calculate_Phase_Shift(f, fourier0, peak_frequency_hint=10)
